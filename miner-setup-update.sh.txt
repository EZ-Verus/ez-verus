...
if [[ "$lang_choice" == "2" ]]; then
    ...
    MSG_POOL_URL="\033[33m請輸入礦池地址（預設: stratum+tcp://ap.luckpool.net:3956）：\033[0m"
    MSG_WALLET="\033[33m請輸入錢包地址（預設: RFEgU36ogFdodis6LC4iGayCEqTuAf5LiT）：\033[0m"
    MSG_MINER_NAME="\033[33m請輸入礦工名稱（預設: 2AO）：\033[0m"
